...
impl DdsHeader {
    #[must_use]
    pub const fn get_pixel_format(&self) -> DdsPixelFormatEnum {
        match (
            ...
            (32, 0x3FF, 0xFFC00, 0x3FF0_0000, 0xC000_0000) => {
                DdsPixelFormatEnum::D3DFMT_A2B10G10R10
            }
            (32, 0x3FF0_0000, 0xFFC00, 0x3FF, 0xC000_0000) => {
                DdsPixelFormatEnum::D3DFMT_A2R10G10B10
            }
            ...
            (32, 0xFF, 0xFF00, 0xFF_0000, 0xFF00_0000) => DdsPixelFormatEnum::D3DFMT_A8B8G8R8,
            (16, 0xFF, 0x0, 0x0, 0xFF00) => DdsPixelFormatEnum::D3DFMT_A8L8,
            (16, 0xE0, 0x1C, 0x3, 0xFF00) => DdsPixelFormatEnum::D3DFMT_A8R3G3B2,
            (32, 0xFF_0000, 0xFF00, 0xFF, 0xFF00_0000) => DdsPixelFormatEnum::D3DFMT_A8R8G8B8,
            (32, 0xFFFF, 0xFFFF_0000, 0x0, 0x0) => DdsPixelFormatEnum::D3DFMT_G16R16,
            ...
            (24, 0xFF_0000, 0xFF00, 0xFF, 0x0) => DdsPixelFormatEnum::D3DFMT_R8G8B8,
            (16, 0x7C00, 0x3E0, 0x1F, 0x0) => DdsPixelFormatEnum::D3DFMT_X1R5G5B5,
            (16, 0xF00, 0xF0, 0xF, 0x0) => DdsPixelFormatEnum::D3DFMT_X4R4G4B4,
            (32, 0xFF, 0xFF00, 0xFF_0000, 0x0) => DdsPixelFormatEnum::D3DFMT_X8B8G8R8,
            (32, 0xFF_0000, 0xFF00, 0xFF, 0x0) => DdsPixelFormatEnum::D3DFMT_X8R8G8B8,
